...
// sateliteAddress,"Moonbeam"
    ...
    //Transfer Winnings to Satelite Contract of the chain the winner was found.   ab,binance,"0xa95b7843825449DC588EC06018B48019D1111000"
    function payWinnerForeignChain( string memory gameHash, string memory destinationChain, address destinationAddress) public payable { 
        if (!games[gameHash])
        {
            uint amountToTransfer = gameBalance[gameHash];
            gameBalance[gameHash] = 0;
    ...
    function payPrize(string memory gameHash) public payable {
    ...
    */  
    // 3,ab,false,binance,"0xa95b7843825449DC588EC06018B48019D1111000" 
    function sendMessageToLocalSatelite( uint256 messageCode, string memory gameHash, bool gameState, string memory winnerChain, string memory winner) public payable {
        if (messageCode==1)
        {
            if (gameState)
            {
    ...
    function sendMessageToSatelites(uint256 satelineNum, uint256 messageCode, string memory gameHash, bool gameState, string memory winnerChain, string memory winner) public payable {
        string memory destinationChain = satelitesChainsArray[satelineNum];
    ...
    // binance,"0xe295348aC14AdC064273d71A21f6520b2B634884",3,ab,false,binance,"0xa95b7843825449DC588EC06018B48019D1111000"
    /// OK Send a message cross chain to a specific chain and specific contract destinationChain : binance    destinationAddress: AxelarManager.sol address.  binance,"0xe295348aC14AdC064273d71A21f6520b2B634884",2,dbc,false,binance,"0xa95b7843825449DC588EC06018B48019D1111000"
    ...
    /// destinationChain : binance , AxelarManager.sol address, amount, gameHash. "binance","0xe295348aC14AdC064273d71A21f6520b2B634884",10000000,"stbHashIPFS_67918"
