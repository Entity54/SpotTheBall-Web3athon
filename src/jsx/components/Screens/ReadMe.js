...
import ngs from "../../../images/Newgamestarted.png";
import playtickets from "../../../images/Playtickets.png";
import winnerannounced from "../../../images/Winnerannounced.png";
import halloffame from "../../../images/Halloffame.png";
import transs from "../../../images/Transferfundsfromsatelites.png";
import transw from "../../../images/Transferingfundstowinner.png";
										...
										<ul className="timeline">
											<li>
												<div className="timeline-badge primary"></div>
													...
													<p className="mx-4 mt-4" style={{ color:"yellow",fontSize:"34px"}}>
													<img src={winnerannounced}></img><br></br>
													</p>
													<p className="mx-4 mt-4 text-dark" style={{ fontSize:"24px"}}>
													Other Screenshots
													<br></br>
													...
													<p className="mx-4 mt-4" style={{ color:"yellow",fontSize:"34px"}}>
													<img src={transs}></img><br></br>
													</p>
													<p className="mx-4 mt-4" style={{ color:"yellow",fontSize:"34px"}}>

													<img src={transw}></img><br></br>
													</p>
													<p className="mx-4 mt-4 text-dark" style={{ fontSize:"24px"}}>
